					...
					<tr>
						...
						<td class="col-2">
							...
							<div style="display:flex; flex-direction:row;">
								...
								<form action="/comment/like" method="post">
									<input type="image" class="mx-1 border rounded"  style="width:20px; height:20px;" src="/resources/plus-lg.svg">
								...
								<form action="/comment/like" method="post">
									<input type="image"  class="mx-1 border rounded" style="width:20px; height:20px;" src="/resources/dash-square.svg">
									<input type="hidden" name="like"  value="${vo.like-1}" >
									<input type = "hidden" name = "cnt" value = "${vo.cnt}">
									<input type = "hidden" name = "moviename" value="${vo.moviename}">
									<input type="hidden" name="id" value="${movieId}">
						...
						<c:if test="${vo.nickname == sessionScope.user.nickname}">
							<form action="/comment/delete" method="post">
								<input type="image" name="delete" src="/resources/delete.png" style="width:20px; height:20px;">
								<input type = "hidden" name = "cnt" value = "${vo.cnt}">
								<input type="hidden" name="moviename" value="${vo.moviename}" >
								<input type="hidden" name="id" value="${movieId}">
								<input type="hidden" name="curMovie" value="${sessionScope.curMovie}" >
