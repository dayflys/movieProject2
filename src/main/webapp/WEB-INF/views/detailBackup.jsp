<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="com.example.movieedu.model.vo.MemberVO,com.example.movieedu.model.vo.MovieVO, com.example.movieedu.model.vo.CommentVO, java.util.List, java.util.ArrayList" %>
		...
		<div class="container bg-white mx-auto mt-3" style="width:80vw; height:auto; color:black; border-radius:30px; padding-bottom:15px;">
			...
			<table class="table " style = "font-weight :bold ;">
				...
				<c:forEach var="item" items = "${commentlist}"  begin="0" end="3" >
					<tr>
						<td class="col-2">${ vo.moviename }</td>
